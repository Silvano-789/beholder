...
function QuantityInput(props) {
    ...
    /* 
    *  funçao de calculo de tamanho e valor da ordem manual, 
    *  baseado no saldo da wallet 
    */
    ...
    const quantityInput = useMemo(() => (
        <div className='form-group'>
            ...
            <div className='input-group'>
                ...
                <input type="number" id={props.id} ref={inputQuantity}
                    className='form-control' placeholder={props.symbol.minLotSize} onChange={props.onChange} />
            </div>
        </div>
