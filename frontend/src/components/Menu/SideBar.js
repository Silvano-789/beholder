                ...
                <ul className="nav flex-column pt-3 pt-md-0">
                    ...
                    <li className={getClassName('/dashboard')}>
                        <Link to="/orders" className="nav-link">
                            ...
                            <span className="sidebar-text">Ordens</span>
                        </Link>
                    </li>
                    <li className={getClassName('/automations')}>
                        <Link to="/automations" className="nav-link">
                            ...
                            <span className="sidebar-text">Automações</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item">
                        <a onClick={onLogoutClick} className="nav-link d-flex align-items-center">
                            <span className="sidebar-icon">
